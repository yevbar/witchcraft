...
KWACTION_N.4: /\b(?:bolster|adapt|incubate|support|amass|airbend|earthbend|waterbend)\b/   // numbered §701 keyword actions (distinctive; '<verb> <N>'); migrated off _kwaction_n: +amass +the Avatar bending family (air/earth/water; 'firebend' is NOT a keyword action)
