...
Validate tiny first:  PYTHONPATH=. python3 witchcraft/experiments/train_magezero_curriculum.py 1 1 3 4 4 4
Real (background):     PYTHONPATH=. python3 witchcraft/experiments/train_magezero_curriculum.py 3 2 16 32 18 30
