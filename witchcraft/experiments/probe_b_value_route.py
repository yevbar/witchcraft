...
Run from repo root: PYTHONPATH=. python3 witchcraft/experiments/probe_b_value_route.py"""
...
def rung_worker(args):
    rung, path = args
    import torch
    from witchcraft.cardnet import CardValueNet, CardNetValue
...
def main():
    from witchcraft.cardnet import CardValueNet, CardNetValue, generate_solver_value, fit, _ExploringValuePlayer
    t0 = time.time()
