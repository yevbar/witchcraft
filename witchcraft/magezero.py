"""witchcraft.magezero — a MageZero-style brain: typed policy/value net + PUCT-MCTS, CPU-only.

This is a structural port of the architecture in WillWroble/MageZero (AlphaZero adapted to MTG,
per deck), built on the witchcraft shim and scoped to JUST the brain — it does NOT wire into the
