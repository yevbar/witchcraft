...
_GLIDE_STEP = 112.0        # px between frames (was 28; each pyautogui.moveTo costs ~13ms, so the glide is
...
class PyAutoGuiActuator:
    ...
    def __init__(self, rect: Optional[Rect] = None, *, duration: float = 0.13, frames: int = 10,
