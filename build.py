...
GENERATED = [
    ...
    "datalog/keyword_action_triggers.dl", "datalog/statements.dl", "datalog/definitions.dl", "datalog/trigger_conditions.dl", "datalog/templates.dl", "datalog/markers.dl", "datalog/keyword_events.dl",
]
