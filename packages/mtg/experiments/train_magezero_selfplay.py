...
Run (validate tiny first):  PYTHONPATH=. python3 mtg/experiments/train_magezero_selfplay.py 1 3 6 4 4
Real (background):          PYTHONPATH=. python3 mtg/experiments/train_magezero_selfplay.py 8 20 16 16 40
