...
pool is actually engaged. Loads the current best (no training). Run:
  PYTHONPATH=. python3 mtg/experiments/verify_deckpool.py"""
...
from mtg.benchmark import benchmark                           # noqa: E402
from mtg.ladder import gauntlet, score_stats                  # noqa: E402
