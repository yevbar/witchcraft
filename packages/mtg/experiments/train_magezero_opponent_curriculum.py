...
Engine-bound work (self-play gen + the gauntlet) runs through mtg.experiments._pool — spawn workers, each
...
Validate tiny:  PYTHONPATH=. python3 mtg/experiments/train_magezero_opponent_curriculum.py mono_white_soldiers 1 1 4 4 8 4 4
Real (bg):      PYTHONPATH=. python3 mtg/experiments/train_magezero_opponent_curriculum.py mono_white_soldiers 3 2 16 32 24 30 8
...
from mtg.magezero import MageZeroNet, fit_clone               # noqa: E402
from mtg.cardnet import generate_clone                        # noqa: E402
from mtg.decks import bundled_decks, load_deck                # noqa: E402
