"""mtg.cardnet — a CARD-AWARE value network (PyTorch) for the ReBeL leaf.
...
PyTorch is an OPTIONAL dependency (`pip install mtg[learn]`); importing the base package
never pulls torch. CPU-only and small by default.

    from mtg.cardnet import train
    from mtg.rebel import ValuePlayer, ReBeLPlayer
