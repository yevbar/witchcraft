"""bench_witchcraft.py — simulation-throughput benchmark for the witchcraft engine.
...
Run: python3 bench_witchcraft.py        (needs datalog/cards.dl + a souffle toolchain for the native binary)
"""
...
def _report(label: str, rate: float) -> None:
    print(f"[witchcraft] {label:34} {rate:8.1f} states/sec  ->  1s={rate:.0f}  5s={5 * rate:.0f}  10s={10 * rate:.0f}")
